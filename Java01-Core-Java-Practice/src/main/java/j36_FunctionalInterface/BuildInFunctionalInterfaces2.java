...
public class BuildInFunctionalInterfaces2 {
    ...
    public static void main(String[] args) {
        ...
        scrumTeam1.forEach(  (k, v) -> System.out.println(k+" : "+v) ); // functional interface with map. You can use for each with map. you can create a lambda expressions represent key and value
