...
public class ArrayOfMap {
    ...
    public static void main(String[] args) {
        ...
        for (Map<String,String> eachMap : array){
            for (Map.Entry<String,String> pairs : eachMap.entrySet()){
                if (pairs.getValue().equalsIgnoreCase("SM")) System.out.println(pairs.getKey());
            }
        }
        ...
        for (Map<String,String> eachMap : array){
            for (Map.Entry<String,String> pairs : eachMap.entrySet()){
                if (pairs.getValue().equalsIgnoreCase("developer")) System.out.println(pairs.getKey());
            }
        }
