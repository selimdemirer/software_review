...
public class OfferObjects {
    ...
    public static void main(String[] args) {
        ...
        Offer[] myOffers = {offer1, offer2, offer3, offer4, offer5}; //We created an array using objects that data type is Offer
        ...
        for (Offer fullTime : fullTimeOffers) {
            System.out.println(fullTime.companyName + " : " + fullTime.salary);
        }
        ...
        for (Offer benefit : offersWithBenefits){
            System.out.println(benefit.companyName + " : " + benefit.salary);
        }
        ...
        for (Offer sDet:sdetOffers){
            System.out.println(sDet.companyName + " : " + sDet.salary);
        }
