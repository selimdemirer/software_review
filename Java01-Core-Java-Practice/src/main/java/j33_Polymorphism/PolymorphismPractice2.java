...
import j32_Abstraction.employeeTask.Developer;
import j32_Abstraction.employeeTask.Employee;
    ...
    public static void main(String[] args) {
        ...
        for (Employee employee : employees) {
            if (employee instanceof Tester) {
                if (employee.getSalary() > testerWithMaxSalary.getSalary()) testerWithMaxSalary = (Tester) employee;
            }
